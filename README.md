...
<div style="display: flex; justify-content: space-around; align-items: center; flex-wrap: wrap;">
  <img src="https://github.com/chjspp520/electricity-info-card/blob/main/v3.3.0.gif" alt="v3.3.0" style="width: 48%; height: auto; margin: 5px;">
...
<div style="display: flex; justify-content: space-around; align-items: center; flex-wrap: wrap;">
  <img src="https://github.com/chjspp520/electricity-info-card/blob/main/V3.2.0.gif" alt="v3.2.0" style="width: 48%; height: auto; margin: 5px;">
...
<div style="display: flex; justify-content: space-around; align-items: center; flex-wrap: wrap;">
  <img src="https://github.com/chjspp520/electricity-info-card/blob/main/v3.1.1-1.gif" alt="v3.1.0" style="width: 48%; height: auto; margin: 5px;">
  <img src="https://github.com/chjspp520/electricity-info-card/blob/main/v3.1.1-2.png" alt="v3.1.0" style="width: 48%; height: auto; margin: 5px;">
